...
import SteaksCard from "../../components/CategoriesPagesCard/SteaksCard";
...
const Steaks = () => {
  const { data, isLoading, error } = useQuery({
    queryKey: ["steaks"],
    queryFn: async () => {
      const response = await fetch("https://foodpoint-backend-venk.onrender.com/steaks");
