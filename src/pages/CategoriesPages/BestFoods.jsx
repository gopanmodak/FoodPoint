...
import BestFoodsCard from "../../components/CategoriesPagesCard/BestFoodsCard";
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 p-5">
        {data.map((bestFood)=> (
          <Fade key={bestFood._id} triggerOnce damping={0.7} cascade direction="up">
            <BestFoodsCard bestFood={bestFood}/>
          </Fade>
        )
        )}
      </div>
