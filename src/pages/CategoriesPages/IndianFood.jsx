...
import IndianFoodCard from "../../components/CategoriesPagesCard/IndianFoodCard";
...
const IndianFood = () => {
  const { data, isLoading, error } = useQuery({
    queryKey: ["indianfood"],
    queryFn: async () => {
      const response = await fetch("https://foodpoint-backend-venk.onrender.com/indianfoods");
