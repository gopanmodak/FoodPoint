...
import OurFoodCard from './../../components/CategoriesPagesCard/OurFoodCard';
...
const OurFood = () => {
  const { data, isLoading, error } = useQuery({
    queryKey: ["ourfood"],
    queryFn: async () => {
      const response = await fetch("https://foodpoint-backend-venk.onrender.com/ourfoods");
